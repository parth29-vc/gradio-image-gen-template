...
pipe.load_lora_weights(hf_hub_download("parth29vc/shm-v2", "shm-v4.safetensors"))
...
with gr.Blocks(theme=gr.themes.Soft()) as demo:
    gr.Markdown(
        ...
        <div style="text-align: center; max-width: 650px; margin: 0 auto;">
            <h1 style="font-size: 2.5rem; font-weight: 700; margin-bottom: 1rem; display: contents;">SHM-FLUX-LoRA</h1>
            <p style="font-size: 1rem; margin-bottom: 1.5rem;">From ViitorAI Team</p>
        </div>
        """
    )
